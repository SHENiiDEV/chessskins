            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
                ...
                <div className="p-6 sm:p-8 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                    <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-amber-500 to-yellow-300 flex items-center justify-center font-black text-2xl text-slate-950 shadow-xl shadow-amber-500/20">
                    ...
                    {/* Balance */}
                    <div className="flex items-center gap-4 bg-slate-950 px-5 py-4 rounded-2xl border border-slate-800">
                        <div>
                            <span className="text-xs font-medium text-slate-400 uppercase tracking-wider block">Wallet Balance</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-8 p-6 sm:p-8 rounded-3xl bg-slate-900/80 border border-slate-800 space-y-6">
